...
contract Nest_3_Abonus {
    ...
    address _nestAddress;                                           //  nest合约地址
    mapping (address => uint256) ethMapping;                        //  token对应 eth 分红账本
    uint256 _mostDistribution = 50;                                 //  最高nest分红池分配比例
    uint256 _leastDistribution = 20;                                //  最低nest分红池分配比例
    uint256 _distributionTime = 2400000;                            //  nest分红池分配比例每次衰减时间间隔
